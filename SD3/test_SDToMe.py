...
save_dir = os.path.join("/data1/fanghaipeng/project/sora/tomesd/samples/dytome", save_dir)
print(save_dir)
tomesd.apply_patch(pipe, ratio=0.5, ratio_start=ratio_start, ratio_end=ratio_end, sx=2, sy=2, save_dir=save_dir) # Can also use pipe.unet in place of pipe here
image = pipe(
