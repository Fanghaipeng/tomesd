        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                #! save every step
                if save_step:
                    image_save = self.vae.decode(latents / self.vae.config.scaling_factor, return_dict=False)[0]
                    if use_resolution_binning:
                        image_save = self.image_processor.resize_and_crop_tensor(image_save, orig_width, orig_height)
