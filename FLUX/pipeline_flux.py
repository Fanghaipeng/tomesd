            ...
            for i, t in enumerate(timesteps):
                ...
                if mac_test:
                    ...
                    inputs = (
                        ...
                        None, # controlnet_single_block_samples
                        False, # return_dict
                    )
                ...
                #! save every step
                if save_step:
                    latents_save = self._unpack_latents(latents, height, width, self.vae_scale_factor)
                    latents_save = (latents_save / self.vae.config.scaling_factor) + self.vae.config.shift_factor
